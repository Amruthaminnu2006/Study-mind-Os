...
export default function DashboardLayout() {
  ...
  const user = JSON.parse(
    localStorage.getItem("studyos_user") ||
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <aside
        className={`${
          collapsed ? "w-16" : "w-60"
        } bg-sidebar border-r border-sidebar-border flex flex-col transition-all duration-300 hidden md:flex`}
      >
        {/* LOGO */}
        <div className="h-16 flex items-center px-4 border-b border-sidebar-border">
          ...
          <button
            ...
            } text-sidebar-foreground hover:text-sidebar-primary-foreground transition-colors`}
          >
            {collapsed ? (
